...
const universities = graduates.filter(graduate => graduate.university);
...
*/
const populationTotal = zooAnimals.reduce((popTotal, popCurrent) => {return popTotal + popCurrent.population}, 0);
